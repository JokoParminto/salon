  ...
  <div class="card">
      ...
      <div class="">
        <ul class="nav nav-tabs tabs-vertical" role="tablist">
          ...
          <li class="nav-item"> <a class="nav-link <?= isset($_GET['typelaporan']) && $_GET['typelaporan'] == 'data-member'? 'active show' : '' ?>" data-toggle="tab" href="#penyakit" role="tab"><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">Grafik Member Perperiode</span></a> </li>
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane p-20 <?= isset($_GET['typelaporan']) && $_GET['typelaporan'] == 'data-member' ? 'active show' : '' ?>" id="penyakit" role="tabpanel">
